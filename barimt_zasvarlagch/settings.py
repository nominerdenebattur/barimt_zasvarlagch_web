"""
Django settings for barimt_zasvarlagch project.
...
SECRET_KEY = 'django-insecure-$_!adedpt!ti!kler$m65vhad)#djo7n0mnlo4)9f$rs=+#j+v'
...
WSGI_APPLICATION = 'barimt_zasvarlagch.wsgi.application'
...
#ed nariig nemeed "python manage.py collectstatic --noinput" commandiig ajluulsan chin admin panel zugeer bolson
STATIC_URL = "/static/"
